...
if [[ "$1" == "--set" ]]; then
    percent_gfx_power=$2
    echo "Setting Power to $2";
else
    percent_gfx_power=0.5
     # not used yet, was going to accept command line power adjustments
fi
